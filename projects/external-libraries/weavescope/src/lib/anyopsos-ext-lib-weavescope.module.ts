...
import {AnyOpsOSExtLibWeavescopeComponent} from './components/anyopsos-ext-lib-weavescope.component';
...
@NgModule({
  declarations: [
    AnyOpsOSExtLibWeavescopeComponent,
    LoadingComponent,
    NodesErrorComponent,
    NodesChartComponent,
...
export class AnyOpsOSExtLibWeavescopeModule {
}
