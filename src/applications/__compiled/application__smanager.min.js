            ...
            this.snapshotVMContextMenu = [
                ...
                ['<i class="fa fa-server"></i> Restore entire VM', function ($itemScope) {
                    ...
                    if ($itemScope.vm.vm === null) {
                        return modalFactory.openLittleModal('Error while restoring Backup', 'Not found any linked VirtualMachine for ' + $itemScope.vm.name + '. Try doing an Instant VM restore', '.window--smanager .window__main', 'plain');
                    }
