...
import {AnyOpsOSNetappModule} from './anyopsos-module-netapp.module';
import {AnyOpsOSNetappSessionStateModule} from './anyopsos-module-netapp-session-state';


const logger: Logger = getLogger('mainLog');

export class AnyOpsOSNetappFileSystemModule {

  private readonly GetPathModule: AnyOpsOSGetPathModule;
  private readonly NetappModule: AnyOpsOSNetappModule;
  ...
  constructor(private readonly userUuid: string,
    ...
    this.NetappModule  = new AnyOpsOSNetappModule(this.userUuid, this.sessionUuid, this.workspaceUuid, this.connectionUuid);
