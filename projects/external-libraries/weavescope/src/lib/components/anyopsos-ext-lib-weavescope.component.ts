...
@Component({
  ...
  selector: 'aelweaves-anyopsos-ext-lib-weavescope[graphNodes][graphTopologies]',
  templateUrl: './anyopsos-ext-lib-weavescope.component.html',
  styleUrls: ['./anyopsos-ext-lib-weavescope.component.scss']
})
export class AnyOpsOSExtLibWeavescopeComponent implements OnChanges, AfterViewInit, OnDestroy {
