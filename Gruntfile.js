module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        dir: {
            ...
            dev_applications: 'src/applications',
            dev_applications_compiled: 'src/applications/__compiled'
        },

        jshint: {
            main: {
                gruntfile: 'Gruntfile.js',
                src: ['<%= dir.dev_frontend %>/js/main.js', '<%= dir.dev_frontend %>/js/src/**/*.js'],
                options: {
                    jshintrc: '.jshintrc',
                    force: true
                }
            ...
            applications: {
                gruntfile: 'Gruntfile.js',
                src: ['<%= dir.dev_applications %>/**/*.js', '!<%= dir.dev_applications_compiled %>/*.js'],
                options: {
                    jshintrc: '.jshintrc',
                    force: true
                }
        ...
        copy: {
            ...
            applications: {
                expand: true,
                dot: true,
                cwd: '<%= dir.dev_applications_compiled %>',
