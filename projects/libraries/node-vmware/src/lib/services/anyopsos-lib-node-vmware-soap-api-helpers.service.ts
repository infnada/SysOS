...
export class AnyOpsOSLibNodeVmwareSoapApiHelpersService {

  constructor(private readonly LibNodeVmwareSoapApiService: AnyOpsOSLibNodeVmwareSoapApiService) {
  }
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV='http://schemas.xmlsoap.org/soap/envelope/'
  ...
  <SOAP-ENV:Body>
    ...
    return this.AnyOpsOSLibNodeVmwareHelper.doCallSoap(connectionData, xml).pipe(map((data: any) => {
      return this.AnyOpsOSLibNodeVmwareHelper.validResponse(data.NfcFileManagementResponse[0].returnval[0]);
    }));
  }*/
}
