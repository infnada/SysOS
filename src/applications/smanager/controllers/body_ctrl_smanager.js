(function () {
    'use strict';
    smanagerApp.controller('smBodyController', ['$rootScope', '$scope', '$log', '$q', '$interval', '$timeout', 'smanagerFactory', 'connectionsFactory', 'cmanagerFactory', 'ServerFactory', 'ApplicationsFactory', 'modalFactory', '$filter', 'netappFactory', 'toastr',
        function ($rootScope, $scope, $log, $q, $interval, $timeout, smanagerFactory, connectionsFactory, cmanagerFactory, ServerFactory, ApplicationsFactory, modalFactory, $filter, netappFactory, toastr) {
            ...
            var initConnection = function (init) {
                ...
                if (_this.getActiveConnection().so === 'snmp') {
                    ...
                    var getInterfacesStatistics = function () {

                        var oid_promises = [];

                        angular.forEach(_this.getActiveConnection.data.ifaces, function (iface, i) {
                            var ifaceOIDs = {
                                oid: [
                                    ...
                                    '1.3.6.1.2.1.2.2.1.11.' + i, // ifInUcastPkts
                                    '1.3.6.1.2.1.2.2.1.17.' + i, // ifOutUcastPkts
                                    '1.3.6.1.2.1.31.1.1.1.6.' + i, // ifHCInOctets
                                    '1.3.6.1.2.1.31.1.1.1.10.' + i, // ifHCOutOctets
                                    '1.3.6.1.2.1.31.1.1.1.7.' + i, // ifHCInUcastPkts
                                    '1.3.6.1.2.1.31.1.1.1.11.' + i // ifHCOutUcastPkts
                                ],
                                type: 'get'
                            };

                            oid_promises.push(ServerFactory.remoteDoSnmp(_this.activeConnection, ifaceOIDs.oid, ifaceOIDs.type).then(function (data) {

                                _this.getActiveConnection.data.ifaces[i].statistics = data.data.data.data;

                            }).catch (function (e) {
                                $log.error('Infrastructure Manager [%s] -> Error while remoteDoSnmp -> oid [%s] -> ', _this.activeConnection, ifaceOIDs.oid, e);
                            }));

                        });

                        return $q.all(oid_promises).then(function () {
                            console.log(_this.getActiveConnection.data);
                        }).catch(function (e) {
                            console.log(e);
                            console.log(_this.getActiveConnection.data);
                        });
                    ...
                    var getInterfacesData = function () {
                        ...
                        angular.forEach(_this.getActiveConnection.data.ifaces, function (iface, i) {
                            var ifaceOIDs = {
                                oid: [
                                    ...
                                    '1.3.6.1.2.1.2.2.1.3.' + i, // ifType
                                    '1.3.6.1.2.1.2.2.1.4.' + i, // ifMTU
                                    '1.3.6.1.2.1.2.2.1.5.' + i, // ifSpeed
                                    '1.3.6.1.2.1.2.2.1.6.' + i, // ifPhysAddress
                                    '1.3.6.1.2.1.2.2.1.7.' + i, // ifAdminStatus
                                    '1.3.6.1.2.1.2.2.1.8.' + i, // ifOperStatus
                                    // ifMIB
                                    '1.3.6.1.2.1.31.1.1.1.1.' + i, // ifName
                                    '1.3.6.1.2.1.31.1.1.1.18.' + i // ifAlias
                                ],
                                type: 'get'
                            };
                            ...
                            oid_promises.push(ServerFactory.remoteDoSnmp(_this.activeConnection, ifaceOIDs.oid, ifaceOIDs.type).then(function (data) {
                                ...
                                _this.getActiveConnection.data.ifaces[i].info = data.data.data.data;
                        ...
                        return $q.all(oid_promises).then(function () {
                            return getInterfacesStatistics();
                        }).catch(function (e) {
                            console.log(e);
                            console.log(_this.getActiveConnection.data);
                        });
                    ...
                    var getInterfacesOIDs = function (parentOID) {

                        return ServerFactory.remoteDoSnmp(_this.activeConnection, parentOID.oid, 'get-next').then(function (data) {

                            // If get-next result oid starts with XX continue fetching next
                            if (data.data.data.data[0].oid.startsWith('1.3.6.1.2.1.2.2.1.1')) {

                                // Create new array for iface Id
                                _this.getActiveConnection.data.ifaces[data.data.data.data[0].value] = [];

                                return getInterfacesOIDs(data.data.data.data[0]);

                                // If not, start fetching interfaces
                            } else {
                                return getInterfacesData();
                            }

                        }).catch (function (e) {
                            $log.error('Infrastructure Manager [%s] -> Error while remoteDoSnmp -> oid [%s] -> ', _this.activeConnection, parentOID.oid, e);
                        });

                    };

                    var getTotalIfaces = function () {

                        var getTotalIfaces = {
                            oid: '1.3.6.1.2.1.2.1.0', // Returns ifNumber -> 30 <-- number of interfaces
                            type: 'get'
                        };

                        return ServerFactory.remoteDoSnmp(_this.activeConnection, getTotalIfaces.oid, getTotalIfaces.type).then(function (data) {

                            // Set data to connection
                            _this.getActiveConnection.data[getTotalIfaces.oid] = data.data.data.data[0].value;

                            // Get all interfaces Ids
                            return getInterfacesOIDs({oid: '1.3.6.1.2.1.2.2.1.1'});
                        }).catch (function (e) {
                            $log.error('Infrastructure Manager [%s] -> Error while remoteDoSnmp -> oid [%s] -> ', _this.activeConnection, getTotalIfaces.oid, e);
                        });

                    };

                    var getBasicOIDsData = function (parentOID) {
                        return ServerFactory.remoteDoSnmp(_this.activeConnection, parentOID.oid, 'get-next').then(function (data) {

                            // If get-next result oid starts with XX continue fetching next
                            if (data.data.data.data[0].oid.startsWith('1.3.6.1.2.1.1')) {

                                // Set data to connection
                                _this.getActiveConnection.data[parentOID.oid] = data.data.data.data[0].value;

                                return getBasicOIDsData(data.data.data.data[0]);

                            // If not, start fetching interfaces
                            } else {
                                return getTotalIfaces();
                            }
                    ...
                    var getMainSNMPData = function () {

                        _this.getActiveConnection.data = [];
                        _this.getActiveConnection.data.ifaces = [];

                        var mainOID = {
                            oid: '1.3.6.1.2.1.1', // Returns SNMP MIB-2 System -> SonicWALL NSA 3600 (SonicOS Enhanced 6.5.1.2-52n)
                            type: 'get-next'
                        };

                        return ServerFactory.remoteDoSnmp(_this.activeConnection, mainOID.oid, mainOID.type).then(function (data) {

                            // Set data to connection
                            _this.getActiveConnection.data['sysDesc'] = data.data.data.data[0].value;

                            return getBasicOIDsData({oid: '1.3.6.1.2.1.1.1.0'});
                        }).catch (function (e) {
                            $log.error('Infrastructure Manager [%s] -> Error while remoteDoSnmp -> oid [%s] -> ', _this.activeConnection, mainOID.oid, e);
                        });
                    };
                    ...
                    _this.getActiveConnection.oids = [
                        {
                            oid: '1.3.6.1.2.1.1.1.0', // Returns SYS-DESC -> SonicWALL NSA 3600 (SonicOS Enhanced 6.5.1.2-52n)
                            type: 'get'
                        },
                        {
                            oid: '1.3.6.1.2.1.1', // Returns SNMP MIB-2 System -> SonicWALL NSA 3600 (SonicOS Enhanced 6.5.1.2-52n)
                        ...
                        {
                            oid: '1.3.6.1.2.1.1.1.0', // Returns sysObjectID -> 1.3.6.1.2.1.1.2.0:1.3.6.1.4.1.8741.1
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.1.2.0', // Returns sysUpTime ->1.3.6.1.2.1.1.3.0:97715115
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.1.3.0', // Returns sysContact -> 1.3.6.1.2.1.1.4.0:
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.1.4.0', // Returns sysName -> 1.3.6.1.2.1.1.5.0:
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.1.5.0', // Returns sysLocation -> 1.3.6.1.2.1.1.6.0:
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.1.6.0', // Returns sysServices -> 1.3.6.1.2.1.1.7.0:79
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.1.7.0', // Returns ifNumber -> 1.3.6.1.2.1.2.1.0:30 <-- number of interfaces
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.47.1.1.1.1.2', // Returns Maximum Connections -> 1.3.6.1.4.1.8741.1.3.1.1.0:375000
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.47.1.1.1.1.13', // Returns 1.3.6.1.2.1.47.1.1.1.1.13 -> 1.3.6.1.4.1.8741.1.3.1.1.0:375000
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.1.0', // Returns ifNumber -> 30 <-- number of interfaces
                        ...
                        //INTERFACES START
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.1:1
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.1', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.2:2
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.2', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.3:3
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.3', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.4:4
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.4', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.5:5
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.5', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.6:6
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.6', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.7:7
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.7', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.8:8
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.8', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.9:9
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.9', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.10:10
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.10', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.11:11
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.11', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.12:12
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.12', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.13:13
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.13', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.14:14
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.14', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.15:15
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.15', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.16:16
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.16', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.17:17
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.17', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.18:18
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.18', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.19:19
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.19', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.20:20
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.20', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.21:21
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.21', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.268947473:268947473
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.268947473', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.268947985:268947985
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.268947985', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.268949010:268949010
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.268949010', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.268949266:268949266
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.268949266', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.268949522:268949522
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.268949522', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.268950290:268950290
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.268950290', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.268950546:268950546
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.268950546', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.268950802:268950802
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.268950802', // Returns ifIndex -> 1.3.6.1.2.1.2.2.1.1.268951058:268951058
                            type: 'get-next'
                        },
                        {
                            oid: '1.3.6.1.2.1.2.2.1.1.268951058', // Returns ifDescr -> 1.3.6.1.2.1.2.2.1.2.1:X0 (LAN)
                            type: 'get-next'
                        },
                        //INTERFACES END
                        //INTERFACES STATS START
                        {
                            oid: [
                                ...
                                '1.3.6.1.2.1.31.1.1.1.1.1', // ifName
                                '1.3.6.1.2.1.31.1.1.1.18.1' // ifAlias
                            ],
                            type: 'get'
                        },
                        // REPEAT FOR EACH INTERFACE
                        {
                            oid: ['1.3.6.1.2.1.2.2.1.2.2', '1.3.6.1.2.1.2.2.1.3.2', '1.3.6.1.2.1.2.2.1.5.2', '1.3.6.1.2.1.2.2.1.6.2', '1.3.6.1.2.1.2.2.1.7.2', '1.3.6.1.2.1.2.2.1.8.2', '1.3.6.1.2.1.31.1.1.1.6.2', '1.3.6.1.2.1.31.1.1.1.7.2', '1.3.6.1.2.1.31.1.1.1.1.2', '1.3.6.1.2.1.31.1.1.1.18.2'], // Returns
                            type: 'get'
                        },
                        // ...
                        //INTERFACES STATS END
                        //INTERFACES STATS START
                        {
                        ...
                        {
                            oid: '1.3.6.1.2.1.31.1.1.1.7.1', // ifHCInUcastPkts
                            type: 'get'
                        },
                        // REPEAT FOR EACH INTERFACE
                        {
                        ...
                        //INTERFACES STATS START
                        {
                            oid: [
                                '1.3.6.1.2.1.2.2.1.8.1', // ifOperStatus
                                '1.6.3.1.2.1.2.2.1.13.1', // ifInDiscards
                                '1.6.3.1.2.1.2.2.1.19.1', // ifOutDiscards
                                '1.6.3.1.2.1.2.2.1.14.1', // ifInErrors
                                '1.6.3.1.2.1.2.2.1.20.1', // ifOutErrors
                                '1.6.3.1.2.1.2.2.1.10.1', // ifInOctets
                                '1.6.3.1.2.1.2.2.1.16.1', // ifOutOctets
                                '1.6.3.1.2.1.2.2.1.11.1', // ifInUcastPkts
                                '1.6.3.1.2.1.2.2.1.17.1', // ifOutUcastPkts
                                '1.3.6.1.2.1.31.1.1.1.6.1', // ifHCInOctets
                        ...
                        // REPEAT FOR EACH INTERFACE
                        {
                            oid: ['1.3.6.1.2.1.2.2.1.8.2', '1.6.3.1.2.1.2.2.1.13.2', '1.6.3.1.2.1.2.2.1.19.2', '1.6.3.1.2.1.2.2.1.14.2', '1.6.3.1.2.1.2.2.1.20.2', '1.6.3.1.2.1.2.2.1.10.2', '1.6.3.1.2.1.2.2.1.16.2', '1.6.3.1.2.1.2.2.1.11.2', '1.6.3.1.2.1.2.2.1.17.2', '1.3.6.1.2.1.31.1.1.1.6.2', '1.3.6.1.2.1.31.1.1.1.10.2', '1.3.6.1.2.1.31.1.1.1.7.2', '1.3.6.1.2.1.31.1.1.1.11.2'], // Returns
                            type: 'get'
                        },
                        // ...
                    ];
                    ...
                    /*angular.forEach(_this.getActiveConnection.oids, function (oid) {
                        ...
                        return ServerFactory.remoteDoSnmp(_this.activeConnection, oid.oid, oid.type).then(function (data) {
                            console.log(data.data.data.data);
                        }).catch (function (e) {
                            $log.error('Infrastructure Manager [%s] -> Error while remoteDoSnmp -> oid [%s] -> ', _this.activeConnection, oid.oid, e);
                        });
            ...
            this.sendConnect = function (smanagerConnect_form) {
                ...
                if (_this.Form.so === 'windows' || _this.Form.so === 'linux' || _this.Form.so === 'snmp') _this.Form.category = 'standalone';
