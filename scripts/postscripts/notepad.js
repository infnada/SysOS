 ...
 * mxGraph
 */
fs.readFile('dist/anyOpsOS/filesystem/bin/applications/anyopsos-app-notepad.umd.js', 'utf8', async function (err, data) {
  if (err) {
  ...
  fs.writeFile('dist/anyOpsOS/filesystem/bin/applications/anyopsos-app-notepad.umd.js', result, 'utf8', function (err) {
