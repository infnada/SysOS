...
import {AnyOpsOSLibVmwareAlarmService} from './managed-object-types/anyopsos-lib-vmware-alarm.service';
import {AnyOpsOSLibVmwareAlarmManagerService} from './managed-object-types/anyopsos-lib-vmware-alarm-manager.service';
import {AnyOpsOSLibVmwareAuthorizationManagerService} from './managed-object-types/anyopsos-lib-vmware-authorization-manager.service';
import {AnyOpsOSLibVmwareCertificateManagerService} from './managed-object-types/anyopsos-lib-vmware-certificate-manager.service';
import {AnyOpsOSLibVmwareClusterComputeResourceService} from './managed-object-types/anyopsos-lib-vmware-cluster-compute-resource.service';
import {AnyOpsOSLibVmwareClusterEVCManagerService} from './managed-object-types/anyopsos-lib-vmware-cluster-evc-manager.service';
import {AnyOpsOSLibVmwareClusterProfileService} from './managed-object-types/anyopsos-lib-vmware-cluster-profile.service';
import {AnyOpsOSLibVmwareClusterProfileManagerService} from './managed-object-types/anyopsos-lib-vmware-cluster-profile-manager.service';
import {AnyOpsOSLibVmwareComputeResourceService} from './managed-object-types/anyopsos-lib-vmware-compute-resource.service';
import {AnyOpsOSLibVmwareContainerViewService} from './managed-object-types/anyopsos-lib-vmware-container-view.service';
import {AnyOpsOSLibVmwareCryptoManagerService} from './managed-object-types/anyopsos-lib-vmware-crypto-manager.service';
import {AnyOpsOSLibVmwareCryptoManagerHostService} from './managed-object-types/anyopsos-lib-vmware-crypto-manager-host.service';
import {AnyOpsOSLibVmwareCryptoManagerHostKMSService} from './managed-object-types/anyopsos-lib-vmware-crypto-manager-host-kms.service';
import {AnyOpsOSLibVmwareCryptoManagerKmipService} from './managed-object-types/anyopsos-lib-vmware-crypto-manager-kmip.service';
import {AnyOpsOSLibVmwareCustomFieldsManagerService} from './managed-object-types/anyopsos-lib-vmware-custom-fields-manager.service';
import {AnyOpsOSLibVmwareCustomizationSpecManagerService} from './managed-object-types/anyopsos-lib-vmware-customization-spec-manager.service';
import {AnyOpsOSLibVmwareDatacenterService} from './managed-object-types/anyopsos-lib-vmware-datacenter.service';
import {AnyOpsOSLibVmwareDatastoreService} from './managed-object-types/anyopsos-lib-vmware-datastore.service';
import {AnyOpsOSLibVmwareDatastoreNamespaceManagerService} from './managed-object-types/anyopsos-lib-vmware-datastore-namespace-manager.service';
import {AnyOpsOSLibVmwareDiagnosticManagerService} from './managed-object-types/anyopsos-lib-vmware-diagnostic-manager.service';
import {AnyOpsOSLibVmwareDistributedVirtualPortgroupService} from './managed-object-types/anyopsos-lib-vmware-distributed-virtual-portgroup.service';
import {AnyOpsOSLibVmwareDistributedVirtualSwitchService} from './managed-object-types/anyopsos-lib-vmware-distributed-virtual-switch.service';
import {AnyOpsOSLibVmwareDistributedVirtualSwitchManagerService} from './managed-object-types/anyopsos-lib-vmware-distributed-virtual-switch-manager.service';
import {AnyOpsOSLibVmwareEnvironmentBrowserService} from './managed-object-types/anyopsos-lib-vmware-environment-browser.service';
import {AnyOpsOSLibVmwareEventHistoryCollectorService} from './managed-object-types/anyopsos-lib-vmware-event-history-collector.service';
import {AnyOpsOSLibVmwareEventManagerService} from './managed-object-types/anyopsos-lib-vmware-event-manager.service';
import {AnyOpsOSLibVmwareExtensibleManagedObjectService} from './managed-object-types/anyopsos-lib-vmware-extensible-managed-object.service';
import {AnyOpsOSLibVmwareExtensionManagerService} from './managed-object-types/anyopsos-lib-vmware-extension-manager.service';
import {AnyOpsOSLibVmwareFailoverClusterConfiguratorService} from './managed-object-types/anyopsos-lib-vmware-failover-cluster-configurator.service';
import {AnyOpsOSLibVmwareFailoverClusterManagerService} from './managed-object-types/anyopsos-lib-vmware-failover-cluster-manager.service';
import {AnyOpsOSLibVmwareFileManagerService} from './managed-object-types/anyopsos-lib-vmware-file-manager.service';
import {AnyOpsOSLibVmwareFolderService} from './managed-object-types/anyopsos-lib-vmware-folder.service';
import {AnyOpsOSLibVmwareGuestAliasManagerService} from './managed-object-types/anyopsos-lib-vmware-guest-alias-manager.service';
import {AnyOpsOSLibVmwareGuestAuthManagerService} from './managed-object-types/anyopsos-lib-vmware-guest-auth-manager.service';
import {AnyOpsOSLibVmwareGuestFileManagerService} from './managed-object-types/anyopsos-lib-vmware-guest-file-manager.service';
import {AnyOpsOSLibVmwareGuestOperationsManagerService} from './managed-object-types/anyopsos-lib-vmware-guest-operations-manager.service';
import {AnyOpsOSLibVmwareGuestProcessManagerService} from './managed-object-types/anyopsos-lib-vmware-guest-process-manager.service';
import {AnyOpsOSLibVmwareGuestWindowsRegistryManagerService} from './managed-object-types/anyopsos-lib-vmware-guest-windows-registry-manager.service';
import {AnyOpsOSLibVmwareHealthUpdateManagerService} from './managed-object-types/anyopsos-lib-vmware-health-update-manager.service';
import {AnyOpsOSLibVmwareHistoryCollectorService} from './managed-object-types/anyopsos-lib-vmware-history-collector.service';
import {AnyOpsOSLibVmwareHostAccessManagerService} from './managed-object-types/anyopsos-lib-vmware-host-access-manager.service';
import {AnyOpsOSLibVmwareHostActiveDirectoryAuthenticationService} from './managed-object-types/anyopsos-lib-vmware-host-active-directory-authentication.service';
import {AnyOpsOSLibVmwareHostAuthenticationManagerService} from './managed-object-types/anyopsos-lib-vmware-host-authentication-manager.service';
import {AnyOpsOSLibVmwareHostAuthenticationStoreService} from './managed-object-types/anyopsos-lib-vmware-host-authentication-store.service';
import {AnyOpsOSLibVmwareHostAutoStartManagerService} from './managed-object-types/anyopsos-lib-vmware-host-auto-start-manager.service';
import {AnyOpsOSLibVmwareHostBootDeviceSystemService} from './managed-object-types/anyopsos-lib-vmware-host-boot-device-system.service';
import {AnyOpsOSLibVmwareHostCacheConfigurationManagerService} from './managed-object-types/anyopsos-lib-vmware-host-cache-configuration-manager.service';
import {AnyOpsOSLibVmwareHostCertificateManagerService} from './managed-object-types/anyopsos-lib-vmware-host-certificate-manager.service';
import {AnyOpsOSLibVmwareHostCpuSchedulerSystemService} from './managed-object-types/anyopsos-lib-vmware-host-cpu-scheduler-system.service';
import {AnyOpsOSLibVmwareHostDatastoreBrowserService} from './managed-object-types/anyopsos-lib-vmware-host-datastore-browser.service';
import {AnyOpsOSLibVmwareHostDatastoreSystemService} from './managed-object-types/anyopsos-lib-vmware-host-datastore-system.service';
import {AnyOpsOSLibVmwareHostDateTimeSystemService} from './managed-object-types/anyopsos-lib-vmware-host-date-time-system.service';
import {AnyOpsOSLibVmwareHostDiagnosticSystemService} from './managed-object-types/anyopsos-lib-vmware-host-diagnostic-system.service';
import {AnyOpsOSLibVmwareHostDirectoryStoreService} from './managed-object-types/anyopsos-lib-vmware-host-directory-store.service';
import {AnyOpsOSLibVmwareHostEsxAgentHostManagerService} from './managed-object-types/anyopsos-lib-vmware-host-esx-agent-host-manager.service';
import {AnyOpsOSLibVmwareHostFirewallSystemService} from './managed-object-types/anyopsos-lib-vmware-host-firewall-system.service';
import {AnyOpsOSLibVmwareHostFirmwareSystemService} from './managed-object-types/anyopsos-lib-vmware-host-firmware-system.service';
import {AnyOpsOSLibVmwareHostGraphicsManagerService} from './managed-object-types/anyopsos-lib-vmware-host-graphics-manager.service';
import {AnyOpsOSLibVmwareHostHealthStatusSystemService} from './managed-object-types/anyopsos-lib-vmware-host-health-status-system.service';
import {AnyOpsOSLibVmwareHostImageConfigManagerService} from './managed-object-types/anyopsos-lib-vmware-host-image-config-manager.service';
import {AnyOpsOSLibVmwareHostKernelModuleSystemService} from './managed-object-types/anyopsos-lib-vmware-host-kernel-module-system.service';
import {AnyOpsOSLibVmwareHostLocalAccountManagerService} from './managed-object-types/anyopsos-lib-vmware-host-local-account-manager.service';
import {AnyOpsOSLibVmwareHostLocalAuthenticationService} from './managed-object-types/anyopsos-lib-vmware-host-local-authentication.service';
import {AnyOpsOSLibVmwareHostMemorySystemService} from './managed-object-types/anyopsos-lib-vmware-host-memory-system.service';
import {AnyOpsOSLibVmwareHostNetworkSystemService} from './managed-object-types/anyopsos-lib-vmware-host-network-system.service';
import {AnyOpsOSLibVmwareHostNvdimmSystemService} from './managed-object-types/anyopsos-lib-vmware-host-nvdimm-system.service';
import {AnyOpsOSLibVmwareHostPatchManagerService} from './managed-object-types/anyopsos-lib-vmware-host-patch-manager.service';
import {AnyOpsOSLibVmwareHostPciPassthruSystemService} from './managed-object-types/anyopsos-lib-vmware-host-pci-passthru-system.service';
import {AnyOpsOSLibVmwareHostPowerSystemService} from './managed-object-types/anyopsos-lib-vmware-host-power-system.service';
import {AnyOpsOSLibVmwareHostProfileService} from './managed-object-types/anyopsos-lib-vmware-host-profile.service';
import {AnyOpsOSLibVmwareHostProfileManagerService} from './managed-object-types/anyopsos-lib-vmware-host-profile-manager.service';
import {AnyOpsOSLibVmwareHostServiceSystemService} from './managed-object-types/anyopsos-lib-vmware-host-service-system.service';
import {AnyOpsOSLibVmwareHostSnmpSystemService} from './managed-object-types/anyopsos-lib-vmware-host-snmp-system.service';
import {AnyOpsOSLibVmwareHostSpecificationManagerService} from './managed-object-types/anyopsos-lib-vmware-host-specification-manager.service';
import {AnyOpsOSLibVmwareHostStorageSystemService} from './managed-object-types/anyopsos-lib-vmware-host-storage-system.service';
import {AnyOpsOSLibVmwareHostSystemService} from './managed-object-types/anyopsos-lib-vmware-host-system.service';
import {AnyOpsOSLibVmwareHostVflashManagerService} from './managed-object-types/anyopsos-lib-vmware-host-vflash-manager.service';
import {AnyOpsOSLibVmwareHostVirtualNicManagerService} from './managed-object-types/anyopsos-lib-vmware-host-virtual-nic-manager.service';
import {AnyOpsOSLibVmwareHostVmotionSystemService} from './managed-object-types/anyopsos-lib-vmware-host-vmotion-system.service';
import {AnyOpsOSLibVmwareHostVsanInternalSystemService} from './managed-object-types/anyopsos-lib-vmware-host-vsan-internal-system.service';
import {AnyOpsOSLibVmwareHostVsanSystemService} from './managed-object-types/anyopsos-lib-vmware-host-vsan-system.service';
import {AnyOpsOSLibVmwareHostVstorageObjectManagerService} from './managed-object-types/anyopsos-lib-vmware-host-vstorage-object-manager.service';
import {AnyOpsOSLibVmwareHttpNfcLeaseService} from './managed-object-types/anyopsos-lib-vmware-http-nfc-lease.service';
import {AnyOpsOSLibVmwareInventoryViewService} from './managed-object-types/anyopsos-lib-vmware-inventory-view.service';
import {AnyOpsOSLibVmwareIoFilterManagerService} from './managed-object-types/anyopsos-lib-vmware-io-filter-manager.service';
import {AnyOpsOSLibVmwareIpPoolManagerService} from './managed-object-types/anyopsos-lib-vmware-ip-pool-manager.service';
import {AnyOpsOSLibVmwareIscsiManagerService} from './managed-object-types/anyopsos-lib-vmware-iscsi-manager.service';
import {AnyOpsOSLibVmwareLicenseAssignmentManagerService} from './managed-object-types/anyopsos-lib-vmware-license-assignment-manager.service';
import {AnyOpsOSLibVmwareLicenseManagerService} from './managed-object-types/anyopsos-lib-vmware-license-manager.service';
import {AnyOpsOSLibVmwareListViewService} from './managed-object-types/anyopsos-lib-vmware-list-view.service';
import {AnyOpsOSLibVmwareLocalizationManagerService} from './managed-object-types/anyopsos-lib-vmware-localization-manager.service';
import {AnyOpsOSLibVmwareManagedEntityService} from './managed-object-types/anyopsos-lib-vmware-managed-entity.service';
import {AnyOpsOSLibVmwareManagedObjectViewService} from './managed-object-types/anyopsos-lib-vmware-managed-object-view.service';
import {AnyOpsOSLibVmwareMessageBusProxyService} from './managed-object-types/anyopsos-lib-vmware-message-bus-proxy.service';
import {AnyOpsOSLibVmwareNetworkService} from './managed-object-types/anyopsos-lib-vmware-network.service';
import {AnyOpsOSLibVmwareOpaqueNetworkService} from './managed-object-types/anyopsos-lib-vmware-opaque-network.service';
import {AnyOpsOSLibVmwareOptionManagerService} from './managed-object-types/anyopsos-lib-vmware-option-manager.service';
import {AnyOpsOSLibVmwareOverheadMemoryManagerService} from './managed-object-types/anyopsos-lib-vmware-overhead-memory-manager.service';
import {AnyOpsOSLibVmwareOvfManagerService} from './managed-object-types/anyopsos-lib-vmware-ovf-manager.service';
import {AnyOpsOSLibVmwarePerformanceManagerService} from './managed-object-types/anyopsos-lib-vmware-performance-manager.service';
import {AnyOpsOSLibVmwareProfileService} from './managed-object-types/anyopsos-lib-vmware-profile.service';
import {AnyOpsOSLibVmwareProfileComplianceManagerService} from './managed-object-types/anyopsos-lib-vmware-profile-compliance-manager.service';
import {AnyOpsOSLibVmwareProfileManagerService} from './managed-object-types/anyopsos-lib-vmware-profile-manager.service';
import {AnyOpsOSLibVmwarePropertyCollectorService} from './managed-object-types/anyopsos-lib-vmware-property-collector.service';
import {AnyOpsOSLibVmwarePropertyFilterService} from './managed-object-types/anyopsos-lib-vmware-property-filter.service';
import {AnyOpsOSLibVmwareResourcePlanningManagerService} from './managed-object-types/anyopsos-lib-vmware-resource-planning-manager.service';
import {AnyOpsOSLibVmwareResourcePoolService} from './managed-object-types/anyopsos-lib-vmware-resource-pool.service';
import {AnyOpsOSLibVmwareScheduledTaskService} from './managed-object-types/anyopsos-lib-vmware-scheduled-task.service';
import {AnyOpsOSLibVmwareScheduledTaskManagerService} from './managed-object-types/anyopsos-lib-vmware-scheduled-task-manager.service';
import {AnyOpsOSLibVmwareSearchIndexService} from './managed-object-types/anyopsos-lib-vmware-search-index.service';
import {AnyOpsOSLibVmwareServiceInstanceService} from './managed-object-types/anyopsos-lib-vmware-service-instance.service';
import {AnyOpsOSLibVmwareServiceManagerService} from './managed-object-types/anyopsos-lib-vmware-service-manager.service';
import {AnyOpsOSLibVmwareSessionManagerService} from './managed-object-types/anyopsos-lib-vmware-session-manager.service';
import {AnyOpsOSLibVmwareSimpleCommandService} from './managed-object-types/anyopsos-lib-vmware-simple-command.service';
import {AnyOpsOSLibVmwareStoragePodService} from './managed-object-types/anyopsos-lib-vmware-storage-pod.service';
import {AnyOpsOSLibVmwareStorageResourceManagerService} from './managed-object-types/anyopsos-lib-vmware-storage-resource-manager.service';
import {AnyOpsOSLibVmwareTaskService} from './managed-object-types/anyopsos-lib-vmware-task.service';
import {AnyOpsOSLibVmwareTaskHistoryCollectorService} from './managed-object-types/anyopsos-lib-vmware-task-history-collector.service';
import {AnyOpsOSLibVmwareTaskManagerService} from './managed-object-types/anyopsos-lib-vmware-task-manager.service';
import {AnyOpsOSLibVmwareUserDirectoryService} from './managed-object-types/anyopsos-lib-vmware-user-directory.service';
import {AnyOpsOSLibVmwareVcenterVstorageObjectManagerService} from './managed-object-types/anyopsos-lib-vmware-vcenter-vstorage-object-manager.service';
import {AnyOpsOSLibVmwareViewService} from './managed-object-types/anyopsos-lib-vmware-view.service';
import {AnyOpsOSLibVmwareViewManagerService} from './managed-object-types/anyopsos-lib-vmware-view-manager.service';
import {AnyOpsOSLibVmwareVirtualAppService} from './managed-object-types/anyopsos-lib-vmware-virtual-app.service';
import {AnyOpsOSLibVmwareVirtualDiskManagerService} from './managed-object-types/anyopsos-lib-vmware-virtual-disk-manager.service';
import {AnyOpsOSLibVmwareVirtualizationManagerService} from './managed-object-types/anyopsos-lib-vmware-virtualization-manager.service';
import {AnyOpsOSLibVmwareVirtualMachineService} from './managed-object-types/anyopsos-lib-vmware-virtual-machine.service';
import {AnyOpsOSLibVmwareVirtualMachineCompatibilityCheckerService} from './managed-object-types/anyopsos-lib-vmware-virtual-machine-compatibility-checker.service';
import {AnyOpsOSLibVmwareVirtualMachineProvisioningCheckerService} from './managed-object-types/anyopsos-lib-vmware-virtual-machine-provisioning-checker.service';
import {AnyOpsOSLibVmwareVirtualMachineSnapshotService} from './managed-object-types/anyopsos-lib-vmware-virtual-machine-snapshot.service';
import {AnyOpsOSLibVmwareVmwareDistributedVirtualSwitchService} from './managed-object-types/anyopsos-lib-vmware-vmware-distributed-virtual-switch.service';
import {AnyOpsOSLibVmwareVsanUpgradeSystemService} from './managed-object-types/anyopsos-lib-vmware-vsan-upgrade-system.service';
import {AnyOpsOSLibVmwareVstorageObjectManagerBaseService} from './managed-object-types/anyopsos-lib-vmware-vstorage-object-manager-base.service';
...
export class AnyOpsOSLibVmwareService {
  ...
  constructor(private http: HttpClient,
              ...
              private AnyOpsOSLibVmwareHelper: AnyOpsOSLibVmwareHelperService,
              private Alarm: AnyOpsOSLibVmwareAlarmService,
              private AlarmManager: AnyOpsOSLibVmwareAlarmManagerService,
              private AuthorizationManager: AnyOpsOSLibVmwareAuthorizationManagerService,
              private CertificateManager: AnyOpsOSLibVmwareCertificateManagerService,
              private ClusterComputeResource: AnyOpsOSLibVmwareClusterComputeResourceService,
              private ClusterEVCManager: AnyOpsOSLibVmwareClusterEVCManagerService,
              private ClusterProfile: AnyOpsOSLibVmwareClusterProfileService,
              private ClusterProfileManager: AnyOpsOSLibVmwareClusterProfileManagerService,
              private ComputeResource: AnyOpsOSLibVmwareComputeResourceService,
              private ContainerView: AnyOpsOSLibVmwareContainerViewService,
              private CryptoManager: AnyOpsOSLibVmwareCryptoManagerService,
              private CryptoManagerHost: AnyOpsOSLibVmwareCryptoManagerHostService,
              private CryptoManagerHostKMS: AnyOpsOSLibVmwareCryptoManagerHostKMSService,
              private CryptoManagerKmip: AnyOpsOSLibVmwareCryptoManagerKmipService,
              private CustomFieldsManager: AnyOpsOSLibVmwareCustomFieldsManagerService,
              private CustomizationSpecManager: AnyOpsOSLibVmwareCustomizationSpecManagerService,
              private Datacenter: AnyOpsOSLibVmwareDatacenterService,
              private Datastore: AnyOpsOSLibVmwareDatastoreService,
              private DatastoreNamespaceManager: AnyOpsOSLibVmwareDatastoreNamespaceManagerService,
              private DiagnosticManager: AnyOpsOSLibVmwareDiagnosticManagerService,
              private DistributedVirtualPortgroup: AnyOpsOSLibVmwareDistributedVirtualPortgroupService,
              private DistributedVirtualSwitch: AnyOpsOSLibVmwareDistributedVirtualSwitchService,
              private DistributedVirtualSwitchManager: AnyOpsOSLibVmwareDistributedVirtualSwitchManagerService,
              private EnvironmentBrowser: AnyOpsOSLibVmwareEnvironmentBrowserService,
              private EventHistoryCollector: AnyOpsOSLibVmwareEventHistoryCollectorService,
              private EventManager: AnyOpsOSLibVmwareEventManagerService,
              private ExtensibleManagedObject: AnyOpsOSLibVmwareExtensibleManagedObjectService,
              private ExtensionManager: AnyOpsOSLibVmwareExtensionManagerService,
              private FailoverClusterConfigurator: AnyOpsOSLibVmwareFailoverClusterConfiguratorService,
              private FailoverClusterManager: AnyOpsOSLibVmwareFailoverClusterManagerService,
              private FileManager: AnyOpsOSLibVmwareFileManagerService,
              private Folder: AnyOpsOSLibVmwareFolderService,
              private GuestAliasManager: AnyOpsOSLibVmwareGuestAliasManagerService,
              private GuestAuthManager: AnyOpsOSLibVmwareGuestAuthManagerService,
              private GuestFileManager: AnyOpsOSLibVmwareGuestFileManagerService,
              private GuestOperationsManager: AnyOpsOSLibVmwareGuestOperationsManagerService,
              private GuestProcessManager: AnyOpsOSLibVmwareGuestProcessManagerService,
              private GuestWindowsRegistryManager: AnyOpsOSLibVmwareGuestWindowsRegistryManagerService,
              private HealthUpdateManager: AnyOpsOSLibVmwareHealthUpdateManagerService,
              private HistoryCollector: AnyOpsOSLibVmwareHistoryCollectorService,
              private HostAccessManager: AnyOpsOSLibVmwareHostAccessManagerService,
              private HostActiveDirectoryAuthentication: AnyOpsOSLibVmwareHostActiveDirectoryAuthenticationService,
              private HostAuthenticationManager: AnyOpsOSLibVmwareHostAuthenticationManagerService,
              private HostAuthenticationStore: AnyOpsOSLibVmwareHostAuthenticationStoreService,
              private HostAutoStartManager: AnyOpsOSLibVmwareHostAutoStartManagerService,
              private HostBootDeviceSystem: AnyOpsOSLibVmwareHostBootDeviceSystemService,
              private HostCacheConfigurationManager: AnyOpsOSLibVmwareHostCacheConfigurationManagerService,
              private HostCertificateManager: AnyOpsOSLibVmwareHostCertificateManagerService,
              private HostCpuSchedulerSystem: AnyOpsOSLibVmwareHostCpuSchedulerSystemService,
              private HostDatastoreBrowser: AnyOpsOSLibVmwareHostDatastoreBrowserService,
              private HostDatastoreSystem: AnyOpsOSLibVmwareHostDatastoreSystemService,
              private HostDateTimeSystem: AnyOpsOSLibVmwareHostDateTimeSystemService,
              private HostDiagnosticSystem: AnyOpsOSLibVmwareHostDiagnosticSystemService,
              private HostDirectoryStore: AnyOpsOSLibVmwareHostDirectoryStoreService,
              private HostEsxAgentHostManager: AnyOpsOSLibVmwareHostEsxAgentHostManagerService,
              private HostFirewallSystem: AnyOpsOSLibVmwareHostFirewallSystemService,
              private HostFirmwareSystem: AnyOpsOSLibVmwareHostFirmwareSystemService,
              private HostGraphicsManager: AnyOpsOSLibVmwareHostGraphicsManagerService,
              private HostHealthStatusSystem: AnyOpsOSLibVmwareHostHealthStatusSystemService,
              private HostImageConfigManager: AnyOpsOSLibVmwareHostImageConfigManagerService,
              private HostKernelModuleSystem: AnyOpsOSLibVmwareHostKernelModuleSystemService,
              private HostLocalAccountManager: AnyOpsOSLibVmwareHostLocalAccountManagerService,
              private HostLocalAuthentication: AnyOpsOSLibVmwareHostLocalAuthenticationService,
              private HostMemorySystem: AnyOpsOSLibVmwareHostMemorySystemService,
              private HostNetworkSystem: AnyOpsOSLibVmwareHostNetworkSystemService,
              private HostNvdimmSystem: AnyOpsOSLibVmwareHostNvdimmSystemService,
              private HostPatchManager: AnyOpsOSLibVmwareHostPatchManagerService,
              private HostPciPassthruSystem: AnyOpsOSLibVmwareHostPciPassthruSystemService,
              private HostPowerSystem: AnyOpsOSLibVmwareHostPowerSystemService,
              private HostProfile: AnyOpsOSLibVmwareHostProfileService,
              private HostProfileManager: AnyOpsOSLibVmwareHostProfileManagerService,
              private HostServiceSystem: AnyOpsOSLibVmwareHostServiceSystemService,
              private HostSnmpSystem: AnyOpsOSLibVmwareHostSnmpSystemService,
              private HostSpecificationManager: AnyOpsOSLibVmwareHostSpecificationManagerService,
              private HostStorageSystem: AnyOpsOSLibVmwareHostStorageSystemService,
              private HostSystem: AnyOpsOSLibVmwareHostSystemService,
              private HostVFlashManager: AnyOpsOSLibVmwareHostVflashManagerService,
              private HostVirtualNicManager: AnyOpsOSLibVmwareHostVirtualNicManagerService,
              private HostVMotionSystem: AnyOpsOSLibVmwareHostVmotionSystemService,
              private HostVsanInternalSystem: AnyOpsOSLibVmwareHostVsanInternalSystemService,
              private HostVsanSystem: AnyOpsOSLibVmwareHostVsanSystemService,
              private HostVStorageObjectManager: AnyOpsOSLibVmwareHostVstorageObjectManagerService,
              private HttpNfcLease: AnyOpsOSLibVmwareHttpNfcLeaseService,
              private InventoryView: AnyOpsOSLibVmwareInventoryViewService,
              private IoFilterManager: AnyOpsOSLibVmwareIoFilterManagerService,
              private IpPoolManager: AnyOpsOSLibVmwareIpPoolManagerService,
              private IscsiManager: AnyOpsOSLibVmwareIscsiManagerService,
              private LicenseAssignmentManager: AnyOpsOSLibVmwareLicenseAssignmentManagerService,
              private LicenseManager: AnyOpsOSLibVmwareLicenseManagerService,
              private ListView: AnyOpsOSLibVmwareListViewService,
              private LocalizationManager: AnyOpsOSLibVmwareLocalizationManagerService,
              private ManagedEntity: AnyOpsOSLibVmwareManagedEntityService,
              private ManagedObjectView: AnyOpsOSLibVmwareManagedObjectViewService,
              private MessageBusProxy: AnyOpsOSLibVmwareMessageBusProxyService,
              private Network: AnyOpsOSLibVmwareNetworkService,
              private OpaqueNetwork: AnyOpsOSLibVmwareOpaqueNetworkService,
              private OptionManager: AnyOpsOSLibVmwareOptionManagerService,
              private OverheadMemoryManager: AnyOpsOSLibVmwareOverheadMemoryManagerService,
              private OvfManager: AnyOpsOSLibVmwareOvfManagerService,
              private PerformanceManager: AnyOpsOSLibVmwarePerformanceManagerService,
              private Profile: AnyOpsOSLibVmwareProfileService,
              private ProfileComplianceManager: AnyOpsOSLibVmwareProfileComplianceManagerService,
              private ProfileManager: AnyOpsOSLibVmwareProfileManagerService,
              private PropertyCollector: AnyOpsOSLibVmwarePropertyCollectorService,
              private PropertyFilter: AnyOpsOSLibVmwarePropertyFilterService,
              private ResourcePlanningManager: AnyOpsOSLibVmwareResourcePlanningManagerService,
              private ResourcePool: AnyOpsOSLibVmwareResourcePoolService,
              private ScheduledTask: AnyOpsOSLibVmwareScheduledTaskService,
              private ScheduledTaskManager: AnyOpsOSLibVmwareScheduledTaskManagerService,
              private SearchIndex: AnyOpsOSLibVmwareSearchIndexService,
              private ServiceInstance: AnyOpsOSLibVmwareServiceInstanceService,
              private ServiceManager: AnyOpsOSLibVmwareServiceManagerService,
              private SessionManager: AnyOpsOSLibVmwareSessionManagerService,
              private SimpleCommand: AnyOpsOSLibVmwareSimpleCommandService,
              private StoragePod: AnyOpsOSLibVmwareStoragePodService,
              private StorageResourceManager: AnyOpsOSLibVmwareStorageResourceManagerService,
              private Task: AnyOpsOSLibVmwareTaskService,
              private TaskHistoryCollector: AnyOpsOSLibVmwareTaskHistoryCollectorService,
              private TaskManager: AnyOpsOSLibVmwareTaskManagerService,
              private UserDirectory: AnyOpsOSLibVmwareUserDirectoryService,
              private VcenterVStorageObjectManager: AnyOpsOSLibVmwareVcenterVstorageObjectManagerService,
              private View: AnyOpsOSLibVmwareViewService,
              private ViewManager: AnyOpsOSLibVmwareViewManagerService,
              private VirtualApp: AnyOpsOSLibVmwareVirtualAppService,
              private VirtualDiskManager: AnyOpsOSLibVmwareVirtualDiskManagerService,
              private VirtualizationManager: AnyOpsOSLibVmwareVirtualizationManagerService,
              private VirtualMachine: AnyOpsOSLibVmwareVirtualMachineService,
              private VirtualMachineCompatibilityChecker: AnyOpsOSLibVmwareVirtualMachineCompatibilityCheckerService,
              private VirtualMachineProvisioningChecker: AnyOpsOSLibVmwareVirtualMachineProvisioningCheckerService,
              private VirtualMachineSnapshot: AnyOpsOSLibVmwareVirtualMachineSnapshotService,
              private VmwareDistributedVirtualSwitch: AnyOpsOSLibVmwareVmwareDistributedVirtualSwitchService,
              private VsanUpgradeSystem: AnyOpsOSLibVmwareVsanUpgradeSystemService,
              private VStorageObjectManagerBase: AnyOpsOSLibVmwareVstorageObjectManagerBaseService) {
  }
  ...
  getClientVersion(connectionData: ConnectionData): Promise<any> {
    return this.AnyOpsOSLibVmwareHelper.getClientVersion(connectionData);
  }

  connectvCenter(connectionData: ConnectionData): Promise<any> {
    return this.AnyOpsOSLibVmwareHelper.connectvCenter(connectionData);
  }

  connectvCenterSoap(connectionData: ConnectionData): Promise<any> {
    return this.AnyOpsOSLibVmwareHelper.connectvCenterSoap(connectionData);
  }
  ...
  getResourcePool(connectionData: ConnectionData, resourcePool: string): Promise<any> {
    ...
    return this.RetrieveProperties(connectionData, [{
      ...
      return this.AnyOpsOSLibVmwareHelper.validResponse(this.AnyOpsOSLibVmwareHelper.parseVMwareObject(RetrievePropertiesResponse.data.returnval[0]));
    });
  ...
  getHostStorageSystem(connectionData: ConnectionData, esxiHost: string): Promise<any> {
    return this.RetrieveProperties(connectionData, [{
      ...
      return this.AnyOpsOSLibVmwareHelper.validResponse(RetrievePropertiesResponse.data.returnval[0].propSet[0].val[0]._);
    });
  ...
  getHostFirewallRules(connectionData: ConnectionData, esxiHost: string): Promise<any> {
    return this.RetrieveProperties(connectionData, [{
      ...
      return this.AnyOpsOSLibVmwareHelper.validResponse(this.AnyOpsOSLibVmwareHelper.parseVMwareObject(RetrievePropertiesResponse.data.returnval[0].propSet[0].val[0]));
    });
  ...
  getVMFileDataFromDatastore(connectionData: ConnectionData, datastore: string, datastoreName: string, path: string, vmxFile: string): Promise<any> {
    return this.SearchDatastore_Task(
      ...
      return this.AnyOpsOSLibVmwareHelper.validResponse(SearchDatastoreTaskResponse);
    });
  }
   ...
   * Other
   */
  registeranyOpsOSExtension(connectionData: ConnectionData): Promise<any> {
    return this.RegisterExtension(connectionData, {
      ...
      console.log(RegisterExtensionResponse);

      return this.AnyOpsOSLibVmwareHelper.validResponse(RegisterExtensionResponse[0]);
    });
  ...
  createAllBasicDataFilter(connectionData: ConnectionData): Promise<any> {
    return this.CreateFilter(connectionData, {
      ...
      return this.AnyOpsOSLibVmwareHelper.validResponse(this.AnyOpsOSLibVmwareHelper.parseVMwareObject(CreateFilterResponse.data.returnval[0]._));
    });
