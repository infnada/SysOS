...
@Component({
  selector: 'slapp-sysos-libs-application',
  templateUrl: './sysos-libs-application.component.html',
  styleUrls: ['./sysos-libs-application.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class SysosLibsApplicationComponent implements OnInit, AfterViewInit {
