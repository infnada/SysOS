...
import {VMWARE_CONFIG_FILE, VMWARE_PORT, VMWARE_SOAP_COOKIE} from './anyopsos-module-vmware.constants';


const vmwareSessions: WorkspaceToVmwareMap = {};

export class AnyOpsOSVmwareSessionStateModule {
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <Login xmlns="urn:vim25">
      ...
      <userName>${mainServer.credential.fields.UserName}</userName>
      <password>${mainServer.credential.fields.Password.getText()}</password>
    </Login>
  </soap:Body>
</soap:Envelope>`;
