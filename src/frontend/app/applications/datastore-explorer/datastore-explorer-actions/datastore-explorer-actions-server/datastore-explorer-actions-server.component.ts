...
@Component({
  selector: 'app-datastore-explorer-actions-server',
  templateUrl: './datastore-explorer-actions-server.component.html',
  styleUrls: ['./datastore-explorer-actions-server.component.scss']
})
export class DatastoreExplorerActionsServerComponent implements OnInit {
