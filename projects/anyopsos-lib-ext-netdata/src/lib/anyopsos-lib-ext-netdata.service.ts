...
import {AnyOpsOSLibExtDygraphsService} from '@anyopsos/lib-ext-dygraphs';
import {AnyOpsOSLibExtEasypiechartService} from '@anyopsos/lib-ext-easypiechart';
import {AnyOpsOSLibExtGaugejsService} from '@anyopsos/lib-ext-gaugejs';
import {AnyOpsOSLibExtPerfectscrollbarService} from '@anyopsos/lib-ext-perfectscrollbar';
import {AnyOpsOSLibExtPakoService} from '@anyopsos/lib-ext-pako';
import {AnyOpsOSLibExtLzStringService} from '@anyopsos/lib-ext-lz-string';
...
export class AnyOpsOSLibExtNetdataService {
  private connection;
  ...
  constructor(private jQuery: AnyOpsOSLibExtJqueryService,
              private Dygraphs: AnyOpsOSLibExtDygraphsService,
              private gaugeJS: AnyOpsOSLibExtGaugejsService,
              private Ps: AnyOpsOSLibExtPerfectscrollbarService,
              private easyPieChart: AnyOpsOSLibExtEasypiechartService,
              private pakoService: AnyOpsOSLibExtPakoService,
              private LZStringService: AnyOpsOSLibExtLzStringService,
