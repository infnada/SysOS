...
@Component({
  ...
  selector: 'smma-sysos-modal-monitor-alarms',
  templateUrl: './sysos-modal-monitor-alarms.component.html',
  styleUrls: ['./sysos-modal-monitor-alarms.component.scss']
})
export class SysosModalMonitorAlarmsComponent implements OnInit {
