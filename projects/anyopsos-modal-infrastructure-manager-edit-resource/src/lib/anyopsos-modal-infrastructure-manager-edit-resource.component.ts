...
@Component({
  selector: 'smimer-anyopsos-modal-infrastructure-manager-edit-resource',
  templateUrl: './anyopsos-modal-infrastructure-manager-edit-resource.component.html',
  styleUrls: ['./anyopsos-modal-infrastructure-manager-edit-resource.component.scss']
})
export class AnyOpsOSModalInfrastructureManagerEditResourceComponent implements OnInit {
