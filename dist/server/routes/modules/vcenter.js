...
module.exports = function () {
    ...
    this.getClientVersion = function (host, port) {
        var proto;
    ...
    this.connect = function (host, port, username, password) {
    ...
    this.callApi = function (host, port, path, cookie) {
    ...
    this.connectSoap = function (host, port, username, password) {
        var proto;
    ...
    this.callApiSoap = function (host, port, action, xml, cookie) {
        var proto;
