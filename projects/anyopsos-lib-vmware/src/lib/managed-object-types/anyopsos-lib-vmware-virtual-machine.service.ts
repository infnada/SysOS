...
export class AnyOpsOSLibVmwareVirtualMachineService {
  ...
  AcquireTicket(
    ...
    return this.AnyOpsOSLibVmwareHelper.doCallSoap(connectionData, xml).pipe(map((data: any) => {
      return this.AnyOpsOSLibVmwareHelper.validResponse(data.AcquireTicketResponse[0].returnval[0]);
    })).toPromise();
  }
  ...
  AnswerVM(
    ...
    return this.AnyOpsOSLibVmwareHelper.doCallSoap(connectionData, xml).pipe(map((data: any) => {
      return this.AnyOpsOSLibVmwareHelper.validResponse(data.AnswerVMResponse[0]);
    })).toPromise();
  }
  ...
  CreateSnapshot_Task(
    ...
    return this.AnyOpsOSLibVmwareHelper.doCallSoap(connectionData, xml).pipe(map((data: any) => {
      ...
      return this.AnyOpsOSLibVmwareHelper.validResponse(data.CreateSnapshot_TaskResponse[0].returnval[0]);
    })).toPromise();
  }
  ...
  RebootGuest(
    ...
    return this.AnyOpsOSLibVmwareHelper.doCallSoap(connectionData, xml).pipe(map((data: any) => {
      return this.AnyOpsOSLibVmwareHelper.validResponse(data.RebootGuestResponse[0]);
    })).toPromise();
  }
  ...
  ShutdownGuest(
    ...
    return this.AnyOpsOSLibVmwareHelper.doCallSoap(connectionData, xml).pipe(map((data: any) => {
      return this.AnyOpsOSLibVmwareHelper.validResponse(data.ShutdownGuestResponse[0]);
    })).toPromise();
  }
  ...
  UnregisterVM(
    ...
    return this.AnyOpsOSLibVmwareHelper.doCallSoap(connectionData, xml).pipe(map((data: any) => {
      return this.AnyOpsOSLibVmwareHelper.validResponse(data.UnregisterVMResponse[0]);
    })).toPromise();
  }
