...
export class AnyOpsOSAppSftpServerService {
  ...
  reloadPath(connectionUuid: string, path?: string): void {
    ...
    this.FileSystem.getFolder((path ? path : this.dataStore.currentPath), connectionUuid).subscribe(
